...
<body>
  <!-- Cover -->
  <div class="cover">
    <div class="brand">DocGen AI — Documentation</div>
    <h1>${projectName}</h1>
    <div class="subtitle">AI-Powered Project Documentation</div>
    <hr>
  ...
  <div class="toc">
    ...
    ${Object.keys(documentation || {}).map((key, i) =>
      `<div class="toc-item"><strong>${i + 1}.</strong> ${SECTION_LABELS[key] || key}</div>`
    ).join('')}
    ${diagrams?.length ? '<div class="toc-item" style="border-left-color:#a78bfa;margin-top:10px"><strong>📊</strong> Project Diagrams</div>' : ''}
  </div>
  ...
  ${diagramsHtml ? `
    <div class="diagrams-page">
      <div class="section-header">📊 Project Diagrams</div>
      ${diagramsHtml}
    </div>
  ` : ''}
  ...
  <!-- Footer -->
  <div class="footer">
    Generated by DocGen AI — AI-Powered Documentation Generator
  </div>
</body>
</html>`;
